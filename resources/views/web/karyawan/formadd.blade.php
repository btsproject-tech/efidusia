                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select {{ strtolower($akses) != 'superadmin' ? 'readonly' : '' }} class="form-control select2 required" error="Cabang" id="branch">
                                    @foreach ($data_branch as $item)
                                        <option value="{{ $item['id'] }}" {{ isset($data->branch) ? $data->branch == $item['id'] ? 'selected' : ''  : ''}}>{{ $item['kode_cabang'].' - '.$item['nama_cabang'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
