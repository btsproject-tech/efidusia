                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select {{ strtolower($akses) != 'superadmin' ? 'readonly' : '' }}
                                    ...
                                    @foreach ($data_jenis as $item)
                                        <option value="{{ $item }}"
                                            {{ isset($data->type) ? ($data->type == $item ? 'selected' : '') : '' }}>
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="number" id="biaya_jasa" class="form-control required" error="Biaya Jasa"
                                        placeholder="Biaya Jasa"
                                        value="{{ isset($data->biaya_jasa) ? $data->biaya_jasa : '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Alamat</label>
                                <div>
                                    <textarea name="" id="alamat" class="required form-control" error="Alamat">{{ isset($data->alamat) ? $data->alamat : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
