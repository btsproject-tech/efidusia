{{-- {{ dd($akses) }} --}}
@if (isset($akses->verifikasi_sertificate_notaris))
@if ($akses->verifikasi_sertificate_notaris->view == 1)
<input type="hidden" id="update" value="{{ $akses->verifikasi_sertificate_notaris->update }}">
<input type="hidden" id="delete" value="{{ $akses->verifikasi_sertificate_notaris->delete }}">
                ...
                <div class="table-rep-plugin">
                    <div class="table-wrapper">
                        <div class="btn-toolbar">
                            {{-- @if ($akses->verifikasi_sertificate_notaris->insert == 1)
                            <div class="btn-group dropdown-btn-group pull-right"><button type="button"
                                    class="btn btn-success" onclick="RequestCertificateNotaris.add(this, event)"><i
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-4 d-grid gap-2">
                                    <button class="btn btn-block btn-warning"
                                        onclick="RequestCertificateNotaris.filterData(this)">Filter</button>
                                </div>
                            </div>
                        </div> --}}
