@if (isset($akses->invoice))
    @if ($akses->invoice->view == 1)
        <input type="hidden" id="update" value="{{ $akses->invoice->update }}">
        <input type="hidden" id="delete" value="{{ $akses->invoice->delete }}">
        <input type="hidden" id="print" value="{{ $akses->invoice->print }}">
                        ...
                        <div class="table-rep-plugin">
                            <div class="table-wrapper">
                                <div class="btn-toolbar">
                                    @if ($akses->invoice->insert == 1)
                                        <div class="btn-group dropdown-btn-group pull-right"><button type="button"
                                                class="btn btn-success" onclick="Invoice.add(this, event)"><i
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="mb-4 d-grid gap-2">
                                            <button class="btn btn-block btn-warning"
                                                onclick="Invoice.getData(this)">Filter</button>
                                        </div>
                                    </div>
                                </div>
