                ...
                <div id="print-content">
                    <div class="invoice-title">
                        <div class="mb-4">
                            ...
                            <img src="{{ asset ('assets/images/kop_header_mas.jpeg') }}" alt="logo" height="200" width="100%"/>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <table>
                                ...
                                <tr>
                                    <td><label class="font-size-15" for="" style="style="padding:
                                            0px;font-weight: 500;"">{{ strtoupper($data->nama_company) }}</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 200px;"><label class="font-size-15" for=""
                                            style="style="padding: 0px;font-weight: 500;"">
                                            <p>{!! $data->alamat !!}</p>
                                        </label></td>
                                </tr>
                                <tr>
                                    <td><label class="font-size-15" for="" style="style="padding:
                                            0px;font-weight: 500;"">{{ strtoupper($data->no_hp) }}</label></td>
                                </tr>
                                <tr>
                                    <td><label class="font-size-15" for="" style="style="padding:
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <table class="table mb-0" style="font-size: 15px">
                                        <tr>
                                            <td style="width: 10px;"><label class="" for=""
                                                    style="font-weight: 700;padding: 8px;">No</label>
                                            </td>
                                            <td style="width: 150px;"><label class="" for=""
                                                    style="font-weight: 700;padding: 8px;">Item</label></td>
                                            <td style="width: 120px;"><label class="" for=""
                                                    style="font-weight: 700;padding: 8px;">Charge</label></td>
                                            <td style="width: 100px;"><label class="" for=""
                                        ...
                                        @if (!empty($data_item))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="" for=""
                                                        style="font-weight: 400;padding: 8px;">{{ number_format($total, 0, ',', '.') }}</label>
                                                </td>
                                            </tr>
                                            @php
                                                $totalTax = $total * ($data->tax / 100);
                                            @endphp
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="1">
                    ...
                    <div class="row" style="padding-left: 8px;">
                        {{-- <div class="col-md-4">
                            <label style="font-weight: 700;">Bank Account Name : PT. Lumiship Logistik
                                Indonesia</label> <br />
                            <label for="" style="font-weight: 400;">Bank Mandiri Acc No : 14000 2018
                                9503<br />Currency : IDR (Indonesia Rupiah)</label>
                        </div>
                        <div class="col-md-4">
                            <label style="font-weight: 700;">Phone : +62 31 99222878</label> <br />
                            <label for="" style="font-weight: 400;">Email : cs@lumiship.co.id<br />Website :
                                www.lumiship.co.id</label>
                        </div> --}}
                    </div>
                </div>
