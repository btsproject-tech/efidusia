<div class="modal fade bs-example-modal-xl{{ $item->id }}" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" id="detailModal{{ $item->id }}" aria-hidden="true">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Detail Data
                    ...
                    <span class="badge bg-warning">
                        ...
                        {{ $data->Creator->Karyawan->CompanyKaryawan->nama_company }}
                    </span>
                    <span class="badge bg-light text-warning">
                        <i class="mdi mdi-account-circle"></i>
                        {{ $data->Creator->Karyawan->nama_lengkap }}
                    </span>
                </h5>
                        ...
                        <div class="tab-content p-3 text-muted">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('contract_number{{ $item->id }}')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('type_produk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tgl_awal_tenor{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tgl_akhir_tenor{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('remarks{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('seq_numbers{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('no_sk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                                @endif
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="no_sk" class="col-4 col-form-label">
                                                <i class="mdi mdi-file-document"></i> Bill ID
                                            </label>
                                            <div class="col-8 m-auto">
                                                <b>:</b> {{ isset($item->billId ) ? $item->billId : '' }}
                                                @if (isset($item->billId ) && $item->billId != null)
                                                <input type="hidden" name="billId" id="billId{{ $item->id }}"
                                                    value="{{ isset($item->billId ) ? $item->billId : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('billId{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                                @endif
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="no_sk" class="col-4 col-form-label">
                                                <i class="mdi mdi-currency-usd"></i> Biaya PNBP
                                            </label>
                                            <div class="col-8 m-auto">
                                                <b>:</b> Rp. {{ isset($item->biaya_pnbp ) ? format_rp($item->biaya_pnbp)
                                                : '' }}
                                                @if (isset($item->biaya_pnbp ) && $item->biaya_pnbp != null)
                                                <input type="hidden" name="biaya_pnbp" id="biaya_pnbp{{ $item->id }}"
                                                    value="{{ isset($item->biaya_pnbp ) ? $item->biaya_pnbp : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('biaya_pnbp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kode_cabang{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                <b>:</b> {{ isset($data->Creator->Karyawan->nama_lengkap ) ?
                                                $data->Creator->Karyawan->nama_lengkap : '' }}
                                                <input type="hidden" name="cab" id="cab{{ $item->id }}"
                                                    value="{{ isset($data->Creator->Karyawan->nama_lengkap ) ? $data->Creator->Karyawan->nama_lengkap : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('cab{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tanggal_kuasa{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                <b>:</b> {{
                                                isset($data->Creator->Karyawan->CompanyKaryawan->nama_company ) ?
                                                $data->Creator->Karyawan->CompanyKaryawan->nama_company : ''
                                                }}
                                                <input type="hidden" name="cab" id="jenis_pelanggan{{ $item->id }}"
                                                    value="{{ isset($data->Creator->Karyawan->CompanyKaryawan->nama_company ) ? $data->Creator->Karyawan->CompanyKaryawan->nama_company : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('jenis_pelanggan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-8">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        null)
                                                        File : <a href="#"
                                                            onclick="return VerifikasiCertificate.confirmDownload('{{ $m->sertificate_file }}','{{ $m->sertificate_path . $m->sertificate_file }}')">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-end">
                                        <button class="btn btn-outline-success btn-sm mb-2 " type="button"
                                            onclick="VerifikasiCertificate.downloadAllWarkah({{ $item->id }})">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('nama{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('jenis_kelamin{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('status_perkawinan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('no_telp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('ktp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('pekerjaan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('alamat{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('rt{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kelurahan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kecamatan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kabupaten{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('provinsi{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kode_pos{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tempat_lahir{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('nama_pasangan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('pemilik_bpkb{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('npwp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tanggal_lahir{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <input type="hidden" name="debitur" id="debitur{{ $item->id }}"
                                                    value="{{ isset($item->debitur) ? $item->debitur : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('debitur{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('hutang_pokok{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('hutang_barang{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('nilai_jaminan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('merk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('warna{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tipe{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('no_rangka{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('no_mesin{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('nopol{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('nomor_bpkb{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('tahun{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="VerifikasiCertificate.copyToClipboard('kondisi{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <button type="button" class="btn btn-info waves-effect m-1 float-end"
                                        onclick="VerifikasiCertificate.exportMinuta('{{ $item->id }}')">
