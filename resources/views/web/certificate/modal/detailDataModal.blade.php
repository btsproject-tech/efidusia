                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('contract_number{{ $item->id }}')">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('type_produk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tgl_awal_tenor{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tgl_akhir_tenor{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('remarks{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('seq_numbers{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('no_sk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kode_cabang{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('cab{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tanggal_kuasa{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('jenis_pelanggan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <b>:</b> <a href="#"
                                                    onclick="return RequestCertificate.confirmDownload('{{ $item->sertificate_file }}','{{ $item->sertificate_path . $item->sertificate_file }}')">
                                            ...
                                            <div class="col-8">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        null)
                                                        File : <a href="#"
                                                            onclick="return RequestCertificate.confirmDownload('{{ $m->sertificate_file }}','{{ $m->sertificate_path . $m->sertificate_file }}')">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-end">
                                        <button class="btn btn-outline-success btn-sm mb-2 " type="button"
                                            onclick="RequestCertificate.downloadAllWarkah({{ $item->id }})">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('nama{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('jenis_kelamin{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('status_perkawinan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('no_telp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('ktp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('pekerjaan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('alamat{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('rt{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kelurahan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kecamatan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kabupaten{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('provinsi{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kode_pos{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tempat_lahir{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('nama_pasangan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('pemilik_bpkb{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('npwp{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tanggal_lahir{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <input type="hidden" name="debitur" id="debitur{{ $item->id }}"
                                                    value="{{ isset($item->debitur) ? $item->debitur : '' }}">
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('debitur{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('hutang_pokok{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('hutang_barang{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('nilai_jaminan{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('merk{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('warna{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tipe{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('no_rangka{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('no_mesin{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('nopol{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('nomor_bpkb{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('tahun{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 m-auto">
                                                ...
                                                <button class="btn btn-outline-success btn-sm float-end" type="button"
                                                    onclick="RequestCertificate.copyToClipboard('kondisi{{ $item->id }}')">
                                                    <i class="mdi mdi-content-copy"></i>
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <button type="button" class="btn btn-info waves-effect m-1"
                                        onclick="RequestCertificate.exportMinuta('{{ $item->id }}')">
