...
<div class="checkout-tabs">
    ...
    <div class="row content-save">
        <div class="col-xl-2 col-sm-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-customer-tab" data-bs-toggle="pill" href="#v-pills-customer"
                    ...
                    <i class="bx bxs-notepad d-block check-nav-icon mt-4 mb-2"></i>
                    <p class="fw-bold mb-4">Request Sertificate Data</p>
                </a>
                <a class="nav-link" id="v-pills-luminiship-tab" data-bs-toggle="pill" href="#v-pills-luminiship"
                    ...
                    <p class="fw-bold mb-4">Contract Data Certificate</p>
                </a>
            </div>
        </div>
        <div class="col-xl-10 col-sm-9">
                ...
                <div class="card-body">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-customer" role="tabpanel"
                            ...
                            @include('web.certificate.form.requestform')
                        </div>
                        <div class="tab-pane fade" id="v-pills-luminiship" role="tabpanel"
                            aria-labelledby="v-pills-luminiship-tab">
                            @include('web.certificate.form.request_sertificate_contract')
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-sm-6">
                    <a href="" onclick="RequestCertificate.cancel(this, event)"
                        class="btn text-muted d-none d-sm-inline-block btn-link">
                        <i class="mdi mdi-arrow-left me-1"></i> Kembali </a>
                </div> <!-- end col -->
                <div class="col-sm-6">
                    <div class="text-end">
                        <a href="" onclick="RequestCertificate.submit(this, event)" class="btn btn-success">
                            <i class="mdi mdi-truck-fast me-1"></i> Submit All</a>
                    </div>
                </div> <!-- end col -->
            </div> <!-- end row -->
        </div>
