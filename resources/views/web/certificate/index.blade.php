@if (isset($akses->request_sertificate))
@if ($akses->request_sertificate->view == 1)
<input type="hidden" id="update" value="{{ $akses->request_sertificate->update }}">
<input type="hidden" id="delete" value="{{ $akses->request_sertificate->delete }}">
                ...
                <div class="table-rep-plugin">
                    <div class="table-wrapper">
                        <div class="btn-toolbar">
                            @if ($akses->request_sertificate->insert == 1)
                            <div class="btn-group dropdown-btn-group pull-right"><button type="button"
                                    class="btn btn-success" onclick="RequestCertificate.add(this, event)"><i
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-4 d-grid gap-2">
                                    <button class="btn btn-block btn-warning"
                                        onclick="RequestCertificate.filterData(this)">Filter</button>
                                </div>
                            </div>
                        </div>
