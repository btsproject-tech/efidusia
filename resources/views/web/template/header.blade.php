        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo_kecil_dfidusia.png') }}" alt="" height="60">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/dfidusia_panjang1.png') }}" alt="" width="90%">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{ strtoupper(session('username')) }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item text-danger" href="{{ url('user/signOut') }}"><i
