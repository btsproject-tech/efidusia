let InvoiceReport = {
    ...
    moduleApi: () => {
        return "api/" + InvoiceReport.module();
    },
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(InvoiceReport.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(InvoiceReport.module()) + "add";
    },
    ...
    getPostInput: () => {
        let data = {
            ...
            data_item: InvoiceReport.getPostItem(),
            data_item_buy: InvoiceReport.getPostItemBuy(),
            // data_term: InvoiceReport.getPostItemTerm(),
        };
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = InvoiceReport.getPostInput();
            ...
            $.ajax({
                ...
                dataType: "json",
                data: params,
                url: url.base_url(InvoiceReport.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(InvoiceReport.moduleApi()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            ...
            columns: [
                ...
                // },
                {
                    data: "id",
                    render: function (data, type, row) {
                        var html = `<button type="button" data_id="${row.id}" onclick="InvoiceReport.duplicate(this, event)" class="btn btn-warning editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-duplicate"></i></button>&nbsp;`;
                        if (updateAction == 1) {
                        ...
                        if (deleteAction == 1) {
                            ...
                            html += `<button type="button" data_id="${row.id}" onclick="InvoiceReport.delete(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`;
                            // }
                        }
                        return html;
                    },
    ...
    filterDataReport2: async (elm) => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(InvoiceReport.moduleApi()) + `getDataReport`,
                type: "POST",
                data: params,
            },
            deferRender: true,
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(InvoiceReport.moduleApi()) + "delete",
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(InvoiceReport.moduleApi()) + "confirmDelete",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    showDataPort: (elm, type) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(InvoiceReport.moduleApi()) + "showDataPort",
            ...
            success: function (resp) {
                ...
                InvoiceReport.getDataPort(type);
            },
        });
    },
    ...
    getDataPort: (type) => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(InvoiceReport.moduleApiPort()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' type="${tipePort}" country="${row.country}" code="${row.code}" onclick="InvoiceReport.pilihData(this, event)" data_id="${row.id}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    confirm: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(InvoiceReport.moduleApi()) + "confirm",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    addItem: (elm, e) => {
        ...
        newTr
            .find("td#action")
            .html(
                `<button type="button" onclick="InvoiceReport.deleteItem(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`
            );
        table.after(newTr);
    },
    ...
    duplicate: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(InvoiceReport.moduleApi()) + "duplicate",
            beforeSend: () => {
...
$(function () {
    InvoiceReport.wizard();
    InvoiceReport.editor();
    InvoiceReport.setSelect2();
    InvoiceReport.setDate();
    InvoiceReport.filterData();
});
