let Quotation = {
    module: () => {
        return "transaksi/quotation";
    },

    moduleApi: () => {
        return "api/" + Quotation.module();
    },
    ...
    cancel: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Quotation.module()) + "/";
    },

    add: (elm, e) => {
        e.preventDefault();
        window.location.href = url.base_url(Quotation.module()) + "add";
    },
    ...
    getPostInput: () => {
        let data = {
            ...
            data_item: Quotation.getPostItem(),
            data_item_buy: Quotation.getPostItemBuy(),
            // data_term: Quotation.getPostItemTerm(),
        };
    ...
    submit: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            let params = Quotation.getPostInput();
            ...
            $.ajax({
                ...
                dataType: "json",
                data: params,
                url: url.base_url(Quotation.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    getData: async () => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Quotation.moduleApi()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            ...
            columns: [
                ...
                // },
                {
                    data: "id",
                    render: function (data, type, row) {
                        var html = `<button type="button" data_id="${row.id}" onclick="Quotation.duplicate(this, event)" class="btn btn-warning editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-duplicate"></i></button>&nbsp;`;
                        if (updateAction == 1) {
                        ...
                        if (deleteAction == 1) {
                            ...
                            html += `<button type="button" data_id="${row.id}" onclick="Quotation.delete(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`;
                            // }
                        }
                        return html;
                    },
    ...
    delete: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(Quotation.moduleApi()) + "delete",
            beforeSend: () => {
    ...
    confirmDelete: (elm) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(Quotation.moduleApi()) + "confirmDelete",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    showDataPort: (elm, type) => {
        ...
        $.ajax({
            ...
            dataType: "html",
            data: params,
            url: url.base_url(Quotation.moduleApi()) + "showDataPort",
    ...
    getDataPort: (type) => {
        ...
        var data = tableData.DataTable({
            ...
            ajax: {
                url: url.base_url(Quotation.moduleApiPort()) + `getData`,
                type: "POST",
            },
            deferRender: true,
            createdRow: function (row, data, dataIndex) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var html = "";
                        html += `<a href='' type="${tipePort}" country="${row.country}" code="${row.code}" onclick="Quotation.pilihData(this, event)" data_id="${row.id}" class="btn btn-info editable-submit btn-sm waves-effect waves-light"><i class="bx bx-edit"></i></a>&nbsp;`;
                        return html;
                    },
                },
            ],
    ...
    confirm: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(Quotation.moduleApi()) + "confirm",
            beforeSend: () => {
                message.loadingProses("Proses Simpan Data...");
            },
            error: function () {
    ...
    addItem: (elm, e) => {
        ...
        newTr
            .find("td#action")
            .html(
                `<button type="button" onclick="Quotation.deleteItem(this, event)" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="bx bx-trash-alt"></i></button>`
            );
        table.after(newTr);
    },
    ...
    duplicate:(elm, e)=>{
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(Quotation.moduleApi()) + "duplicate",
            beforeSend: () => {
